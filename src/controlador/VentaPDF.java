...
public class VentaPDF {
    ...
    public void generarFacturaPDF() {
        try {
            ...
            Image img = Image.getInstance(getClass().getResource("/img/ventas.png"));
            ...
            String rif = "0987654321001";
            String nombre = "Tecno Store";
            String telefono = "+58 414-1658302";
            String direccion = "4005 Av. Las Delicias, Maracaibo 4005, Zulia, Venezuela";
            String razon = "Ventas de Teléfonos Nuevos, Equipos de Computación y Electrodomésticos.";
            ...
            PdfPCell cliente1 = new PdfPCell(new Phrase("Cedula/RIF: ", negrita));
