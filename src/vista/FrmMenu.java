...
public class FrmMenu extends javax.swing.JFrame {
    ...
    public static modelo.Usuario usuarioSesion;

    public FrmMenu(modelo.Usuario usuario) {
        initComponents(); 
        ...
        // ASIGNAR EL USUARIO A LA VARIABLE ESTATICA Y VALIDAR
        usuarioSesion = usuario;
        this.validarRol();

        // INICIALIZAR EL DESKTOP PANE (Indispensable para que no de error al abrir ventanas)
        jDesktopPane_menu = new javax.swing.JDesktopPane();
        int ancho = java.awt.Toolkit.getDefaultToolkit().getScreenSize().width;
        int alto = java.awt.Toolkit.getDefaultToolkit().getScreenSize().height;
        this.add(jDesktopPane_menu, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, ancho, alto));
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                // Creamos un usuario temporal solo para que la ventana abra
                modelo.Usuario usuarioTemporal = new modelo.Usuario();
                usuarioTemporal.setUsuario("Admin");
                usuarioTemporal.setRol("administrador");

                new FrmMenu(usuarioTemporal).setVisible(true);
            }
        });
    }
    ...
    private void validarRol() {
        if (usuarioSesion.getRol().equalsIgnoreCase("cajero")) {
            // Ocultar menús completos
            jMenu1.setVisible(false); // Menú Usuario
            jMenu4.setVisible(false); // Menú Categoría
            jMenu6.setVisible(false); // Menú Reportes
            jMenu7.setVisible(false); // Menú Historial
            
            // Si quieres ocultar solo opciones específicas de un menú que sí ve:
            // jMenuItem_gestionar_producto.setVisible(false);
        }
    }
}
