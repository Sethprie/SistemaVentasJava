...
public class InterGestionarUsuario extends javax.swing.JInternalFrame {
    ...
    /** Rol del usuario seleccionado en la tabla (necesario para actualizar sin borrar el rol). */
    private String rolUsuarioSeleccionado = "cajero";
            ...
            if (rs.next()) {
                ...
                try {
                    ...
                    if (r != null && !r.trim().isEmpty()) {
                        rolUsuarioSeleccionado = r.trim();
                    }
                } catch (SQLException ex) {
                    // Columna rol ausente en esquemas antiguos
                }
            }
            con.close();
        } catch (SQLException e) {
